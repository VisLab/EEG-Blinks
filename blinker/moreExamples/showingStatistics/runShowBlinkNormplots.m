...
for k = 1:numExp
    ...
    durationZ = occular.durationZ;
    durationB = occular.durationB;
    ...
    experiments(k).durationZ = durationZ(useMask, :);
    experiments(k).durationB = durationB(useMask, :);
