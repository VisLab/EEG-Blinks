...
%% NCTU blinks
% blinkDir = 'O:\ARL_Data\NCTU\NCTUBlinksNewRevised';
% experiment = 'NCTU_LK';
...
blinkDir = 'O:\ARL_Data\BCITBlinksNewRevised';
...
for t = 1:length(theTypes)
    ...
    elseif strcmpi(theTypes{t}, 'headers')
        ...
        for k = 1:length(blinks)
            ocular(k, :) = getOcularIndex(blinks(k), blinkProperties{k}, ...
...
%%
save([blinkDir filesep experiment 'BlinksNew' typeBlinks 'Ocular.mat'], ...
