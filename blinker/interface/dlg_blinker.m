...
%             [3, 5, 2], [3, 5, 2], [3, 5, 2], [0.5, 0.5, 0.5, 0.5, 0.5, 0.5]};

geometry = {[3, 5, 2], [3, 5, 2], [3, 5, 2], [3, 5, 2], [3, 5, 2], ...
            [3, 5, 2], [3, 5, 2], [3, 5, 2], [3, 5, 2], [3, 5, 2], ...
            [3, 5, 2]}; %, [0.5, 0.5, 0.5, 0.5 ]};
...
%     { 'Style', 'checkbox', 'Value', 1, 'horizontalalignment', 'left',  'tag',  'dumpBlinks' }, ...
%     { 'Style', 'text', 'string', 'Show distribution', 'horizontalalignment', 'right'}, ...
%     { 'Style', 'checkbox', 'Value', 1, 'horizontalalignment', 'left',  'tag',  'showDistribution' }, ...
%     };

%    { 'Style', 'text', 'string', 'Signal labels', ...
%       'horizontalalignment', 'right', ...
%       'TooltipString', params.signalLabels.description}, ...
%     { 'Style', 'edit', 'string', params.signalLabels.value, ...
%       'horizontalalignment', 'left',  'tag',  'startTime', ...
%       'TooltipString', params.signalLabels.description}, ...
%     { 'Style', 'text', 'string', '', 'horizontalalignment', 'right'}  ...% Row 11

% [results newcomments buttonPressed outStruct] = inputgui( 'geometry', geometry, ...
%      'geomvert', [], 'uilist', uilist, 'title', theTitle, 'helpcom', 'pophelp(''pop_blinks'')');
