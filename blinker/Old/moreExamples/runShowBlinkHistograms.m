...
for k = 1:numFields
    ...
    xlabel(theFields{k});
    ylabel('Fraction');
    title('Histogram using all blinks')
    legend(legendStrings(1:numLegends))
    ...
    xlabel(theFields{k});
    ylabel('Fraction');
    title('Histogram using prototypical blinks only')
    legend(legendStrings(1:numLegends))
    ...
    xlabel(theFields{k});
    ylabel('Fraction');
    title('Histogram overlaying all and prototypical blinks')
    legend(legendStrings(1:numLegends))
end 
